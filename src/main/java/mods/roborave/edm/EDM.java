...
import mods.roborave.edm.blocks.BlockTest;
import mods.roborave.edm.blocks.render.TestRender;
...
import mods.roborave.edm.items.ItemTest;
...
public class EDM
{
	...
	ClientRegistry.registerTileEntity(TileEntityBlock.class, "TileBlock", render);
	
	GameData.itemRegistry.addObject(500, "test",test);
	
    GameData.blockRegistry.addObject(700, "testBlock", testBlock);
